...
namespace Fasetto.Word
{
    ...
    /// and a reverse aniomation when set to false
    /// </summary>
        ...
        where Parent : BaseAttachedProperty<Parent, bool>, new()
    {
        ...
        /// <summary>
        /// A flag indicating if this is the fist time this property has been loaded
        /// </summary>
        ...
        public override void OnValueUpdated(DependencyObject sender, object value)
        {
            ...
            if(FirstLoad)
            {
                //create a single self-unhookabler event
    ...
    /// </summary>
    public class AnimateFadeInFromProperty : AnimateBaseProperty<AnimateSlideInFromBottomProperty>
    {
        protected override async void DoAnimation(FrameworkElement element, bool value)
        {
            if (value)
